...
const REVEALED_KEY = "shanhaijing-item-discovery-revealed-v1";
...
let revealedSpots = loadRevealed();

function saveRevealed() {
  if (!DEV_MODE) localStorage.setItem(REVEALED_KEY, JSON.stringify([...revealedSpots]));
}
...
export function isDiscoveryRevealed(spotId) { return revealedSpots.has(spotId); }
