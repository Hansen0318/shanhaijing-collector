...
export const maps = [
  {
    ...
    // 第一層正式背景圖；互動物件仍由程式依世界座標另外疊加。
    background: {
      type: "image",
      asset: "./assets/scenes/qingqiu-01.png"
    },
    regions: [
      {
        id: "qingqiu-country",
    ...
    entrances: [
      {
        ...
        icon: "⛰",
        asset: "./assets/entrances/kunlun-gate.png",
  ...
  },
  {
    ...
    entrances: [
      {
        id: "kunlun-01-to-qingqiu-01-entrance",
        type: "map-transition",
        position: { x: 760, y: 1085 },
        radius: 70,
        clueRadius: 210,
        ...
        interactionZoom: 2.0,
        clue: "前方似乎有通往青丘的神秘入口。",
        closeClue: "眼前的山口透出熟悉的氣息，似乎可以返回青丘。",
        icon: "⛰",
        asset: "./assets/entrances/kunlun-gate.png",
        destinationMapId: "qingqiu-01",
        enabled: true
      }
    ]
  }
